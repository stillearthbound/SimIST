...
//        bakeryObjects = new StoreObjects[]{ new Bagels(rand.nextInt(20)) , new Croissants(rand.nextInt(20)) , new Donuts(rand.nextInt(20)) };
        ...
        coffeeObjects = new StoreObjects[]{ new StoreObjects("French Vanilla Coffee",2.50f, rand.nextInt(20), "coffee.png") , new StoreObjects("Regular Coffee",2.50f, rand.nextInt(20), "coffee.png") , new StoreObjects("Seasonal Coffee",2.50f, rand.nextInt(20), "coffee.png"), new StoreObjects("Napkin",2.50f, rand.nextInt(50), "napkin.png"), new StoreObjects("Utensils",2.50f, rand.nextInt(20), "utensils.png")};
